...
# ============================================
MPESA_CONSUMER_KEY=wnG2W3rRRtUcNM4BaxvNliM1tnpiPuV1Gvf6V0p15BjFeAYe
MPESA_CONSUMER_SECRET=tZSi8VziDgQPurtgppLFYy0OdNyhyjfBVeW0bWokb9kScdmmt1D1UcHKovraaoCB
